...
enum class MpcEvent
{
    ...
    SWITCHING_FROM_FULLSCREEN_D3D,
    SWITCHED_FROM_FULLSCREEN_D3D,
    MEDIA_LOADED,
    ...
    PLAYBACK_ENTERING_STOP,
    MEDIA_CHAPTERBAG_CHANGED,
    MEDIA_DURATION_CHANGED,
    MEDIA_POSITION_CHANGED,
    MEDIA_FILE_METADATA_CHANGED,
    OSD_REINITIALIZE_PAINTER,
    VR_WINDOW_DATA_CHANGED,
};
